...
# 走棋模式列表
cdata = [# 一个棋子的情况
        [ N, N, N, S, B ], [ B, S, N, N, N ], [ N, B, S, N, N ], [ N, N, S, B, N ],
        [ N, N, B, S, N ], [ N, N, N, S, W ], [ W, S, N, N, N ], [ N, W, S, N, N ],
        [ N, N, S, W, N ], [ N, N, W, S, N ],
        # 两个棋子的情况
        ...
        [ N, W, W, S, N ], [ N, S, W, W, N ],
        # 三个棋子的情况
        [ N, S, B, B, B ], [ B, B, B, S, N ], [ N, B, S, B, B ], [ B, B, S, B, N ],
        [ N, B, B, S, B ], [ B, S, B, B, N ], [ N, B, B, B, S ], [ N, S, W, W, W ],
        [ W, W, W, S, N ], [ N, W, S, W, W ], [ W, W, S, W, N ], [ N, W, W, S, W ],
        [ W, S, W, W, N ], [ N, W, W, W, S ],
        # 四个棋子的情况
